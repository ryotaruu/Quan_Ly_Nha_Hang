...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Local Listings</h3>
        </div>
        <!-- /.card-header -->
        <div class="card-body">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                        colspan="1" aria-label="Name Category">Local Name</th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                        colspan="1" aria-label="Desc Category">Local Description</th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td>
                                            ...
                                            if($Data->local_status == 0){
                                                echo "<a href='/Hide-Local-Food/$Data->local_id'><i class='fa-solid fa-toggle-off'></i> Hide</a>";
                                            }else {
                                                echo "<a href='/Show-Local-Food/$Data->local_id'><i class='fa-solid fa-toggle-on'></i>Show</a>";
                                            }
                                            ?>
                                        </td>
